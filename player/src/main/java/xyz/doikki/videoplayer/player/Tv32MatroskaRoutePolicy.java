...
final class Tv32MatroskaRoutePolicy {
    ...
    static boolean shouldUseDirectUri(boolean hdrLike, boolean startupPreflight) {
        ...
        // open an encoded E-AC3 track against the speaker output, which is silent. The fast
        // startup preflight preserves that released route when HDR metadata is not yet visible.
        return hdrLike || startupPreflight;
    }
